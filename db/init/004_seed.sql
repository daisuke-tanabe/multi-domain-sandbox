...
INSERT INTO identity.oidc_clients (client_id, client_secret_hash, name, audience, backchannel_logout_uri) VALUES
  ...
  ('cms', 'scrypt$c2FuZGJveC1maXhlZC1zYWx0$R2io-GheJszjo_f1mrYAMPWACmY2sbFLGdvcJH1kS98', 'CMS', 'http://api.cms.localhost:3002', 'http://cms.localhost:3001/auth/backchannel-logout');
...
INSERT INTO identity.oidc_client_redirect_uris (client_id, redirect_uri, tenant_id) VALUES
  ...
  ('cms', 'http://tanaka.cms.localhost:3001/auth/callback', '01J00000000000000000TANAKA0'),
  ('cms', 'http://suzuki.cms.localhost:3001/auth/callback', '01J00000000000000000SUZUKI0');
